...
@set JAVAPROJ=D:\\Development\\IntelliJProjects\\SD\
@Set RABBITMQ_SERVICES_FOLDER=edu/ufp/inf/sd/rmq
@Set RABBITMQ_SERVICES_PACKAGE=edu.ufp.inf.sd.rmq
@Set PACKAGE=_02_workqueues
@Set QUEUE_NAME_PREFIX=workqueues
